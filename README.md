...
This local command requires Chrome installed on the machine. For free unattended execution, use GitHub Actions as described below.

## Free Scheduled Hosting with GitHub Actions

GitHub Actions provides hosted Linux runners with Chrome. Public repositories generally have free scheduled usage; private repositories use the account's included Actions minutes.
...
5. Run **Collect AliExpress Coins** manually once to test it. It then runs daily at 08:00 UTC.
